...
var $author$project$User$User = F5(
	function (id, name, country, gender, age) {
		return {age: age, country: country, gender: gender, id: id, name: name};
	});
...
var $author$project$User$decoder = A6(
	$elm$json$Json$Decode$map5,
	...
	A2($elm$json$Json$Decode$field, 'age', $elm$json$Json$Decode$string));
var $author$project$User$decode = function (value) {
	return A2(
		$elm$core$Result$andThen,
		$elm$json$Json$Decode$decodeString($author$project$User$decoder),
	...
	var baseUrl = function () {
		...
		switch (_v0) {
			case 'localhost':
				return _Utils_update(
					url,
					{fragment: $elm$core$Maybe$Nothing, host: 'codenamesgreen.herokuapp.com', path: '', query: $elm$core$Maybe$Nothing});
...
var $author$project$Main$IndexData = function (a) {
	return {$: 'IndexData', a: a};
};
var $author$project$Main$NotFound = {$: 'NotFound'};
var $author$project$Main$NullRoute = {$: 'NullRoute'};
var $author$project$Api$Index = function (autogeneratedId) {
	return {autogeneratedId: autogeneratedId};
};
var $author$project$Api$decodeIndex = A2(
	$elm$json$Json$Decode$map,
	$author$project$Api$Index,
	A2($elm$json$Json$Decode$field, 'autogenerated_id', $elm$json$Json$Decode$string));
...
var $author$project$Api$endpointUrl = F2(
...
var $author$project$Api$index = F2(
...
var $author$project$Main$GameLoading = function (a) {
	return {$: 'GameLoading', a: a};
};
var $author$project$Main$GotGame = function (a) {
	return {$: 'GotGame', a: a};
};
var $author$project$Api$GameState = F6(
	function (id, seed, words, events, oneLayout, twoLayout) {
		return {events: events, id: id, oneLayout: oneLayout, seed: seed, twoLayout: twoLayout, words: words};
	});
var $author$project$Color$Black = {$: 'Black'};
var $author$project$Color$Green = {$: 'Green'};
var $author$project$Color$Tan = {$: 'Tan'};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Color$decode = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Api$Event = F7(
	function (number, typ, playerId, name, side, index, message) {
		return {index: index, message: message, name: name, number: number, playerId: playerId, side: side, typ: typ};
	});
var $elm$json$Json$Decode$array = _Json_decodeArray;
var $author$project$Side$A = {$: 'A'};
var $author$project$Side$B = {$: 'B'};
var $author$project$Side$decodeMaybe = A2(
	$elm$json$Json$Decode$andThen,
	function (i) {
		switch (i) {
			case 1:
...
var $author$project$Api$decodeEvent = A8(
...
var $author$project$Api$decoderGameState = A7(
	...
	$author$project$Api$GameState,
	A2($elm$json$Json$Decode$field, 'game_id', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'state',
	...
	A2(
		$elm$json$Json$Decode$field,
		'one_layout',
		$elm$json$Json$Decode$list($author$project$Color$decode)),
	A2(
		$elm$json$Json$Decode$field,
		'two_layout',
		$elm$json$Json$Decode$list($author$project$Color$decode)));
	...
	return $elm$http$Http$post(
		{
			...
			expect: A2($elm$http$Http$expectJson, r.toMsg, $author$project$Api$decoderGameState),
			url: A2($author$project$Api$endpointUrl, r.client.baseUrl, '/new-game')
		});
};
var $author$project$Main$stepGameView = F3(
	function (model, id, prevSeed) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
			...
			return _Utils_Tuple2(
				{
					...
					key: key,
					page: $author$project$Main$Error(
						$elm$json$Json$Decode$errorToString(e)),
					user: A5($author$project$User$User, '', '', '', '', '')
				},
				$elm$core$Platform$Cmd$none);
		} else {
			var user = _v0.a;
...
var $author$project$Main$GameInProgress = F3(
	function (a, b, c) {
		return {$: 'GameInProgress', a: a, b: b, c: c};
	});
var $author$project$Main$GameUpdate = function (a) {
	return {$: 'GameUpdate', a: a};
};
var $author$project$Main$NoOp = {$: 'NoOp'};
var $author$project$Main$ShowDefault = {$: 'ShowDefault'};
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'game_id',
							$elm$json$Json$Encode$string(r.gameId)),
							_Utils_Tuple2(
							'seed',
							$elm$json$Json$Encode$string(r.seed)),
							_Utils_Tuple2(
							'player_id',
							$elm$json$Json$Encode$string(r.player.user.id)),
							_Utils_Tuple2(
							'name',
							$elm$json$Json$Encode$string(r.player.user.name)),
							_Utils_Tuple2(
							'team',
							$author$project$Side$encodeMaybe(r.player.side)),
							_Utils_Tuple2(
							'message',
...
var $author$project$Cell$Cell = F4(
	function (index, word, a, b) {
		return {a: a, b: b, index: index, word: word};
	});
var $author$project$Game$ShowWords = {$: 'ShowWords'};
var $author$project$Cell$ExposedGreen = {$: 'ExposedGreen'};
...
var $author$project$Cell$ExposedBlack = {$: 'ExposedBlack'};
var $author$project$Cell$Hidden = F2(
	function (a, b) {
		return {$: 'Hidden', a: a, b: b};
	});
...
var $author$project$Cell$sideColor = F2(
	function (side, cell) {
		if (side.$ === 'A') {
			return cell.a.b;
		} else {
...
var $author$project$Game$hasHiddenGreens = F2(
	function (side, cells) {
		return A2(
			$elm$core$List$any,
			function (x) {
				return _Utils_eq(
					A2($author$project$Cell$sideColor, side, x),
					$author$project$Color$Green);
			},
			A2(
				$elm$core$List$filter,
				function (x) {
					return !_Utils_eq(
						$author$project$Cell$display(x),
						$author$project$Cell$ExposedGreen);
				},
				$elm$core$Array$toList(cells)));
	});
var $author$project$Side$opposite = function (side) {
	if (side.$ === 'A') {
		return $author$project$Side$B;
	} else {
		return $author$project$Side$A;
	}
};
var $author$project$Cell$oppColor = F2(
	function (side, cell) {
		return A2(
			$author$project$Cell$sideColor,
			$author$project$Side$opposite(side),
			cell);
	});
...
var $author$project$Cell$tapped = F2(
	function (side, cell) {
		if (side.$ === 'B') {
			return _Utils_update(
				cell,
...
var $author$project$Game$applyGuess = F4(
	function (e, cell, side, model) {
		if (_Utils_eq(
			model.turn,
			$elm$core$Maybe$Just(
				$author$project$Side$opposite(side)))) {
			...
			var updatedCells = A3(
				$elm$core$Array$set,
				e.index,
				A2($author$project$Cell$tapped, side, cell),
				model.cells);
				...
				case 'Tan':
					return _Utils_update(
						model,
						{
							...
							turn: A2($author$project$Game$hasHiddenGreens, side, updatedCells) ? $elm$core$Maybe$Just(
								$author$project$Side$opposite(side)) : $elm$core$Maybe$Just(side)
						});
				case 'Green':
					return A2(
						$author$project$Game$hasHiddenGreens,
						$author$project$Side$opposite(side),
						updatedCells) ? _Utils_update(
						model,
						{
							cells: updatedCells,
							events: A2($elm$core$List$cons, e, model.events),
...
var $author$project$Game$applyEvent = F2(
	function (e, model) {
		if (_Utils_cmp(
			e.number,
			$author$project$Game$lastEvent(model)) < 1) {
			return model;
		} else {
			var _v0 = e.typ;
			switch (_v0) {
				...
				case 'guess':
					var _v3 = _Utils_Tuple2(
						A2($elm$core$Array$get, e.index, model.cells),
						e.side);
					...
					if (_v4.a && (_v4.b.$ === 'Just')) {
						...
						return _Utils_update(
							model,
							{
								...
								guessesThisTurn: 0,
								tokensConsumed: model.tokensConsumed + 1,
								turn: A2($author$project$Game$hasHiddenGreens, side, model.cells) ? $elm$core$Maybe$Just(
									$author$project$Side$opposite(side)) : model.turn
							});
					} else {
						return _Utils_update(
							model,
...
var $author$project$Game$NoOp = {$: 'NoOp'};
...
var $author$project$Game$jumpToBottom = F2(
	function (id, toMsg) {
		return A2(
			$elm$core$Task$attempt,
			$elm$core$Basics$always(
				toMsg($author$project$Game$NoOp)),
			A2(
				$elm$core$Task$andThen,
				function (info) {
...
var $author$project$Game$LongPoll = F3(
	function (a, b, c) {
		return {$: 'LongPoll', a: a, b: b, c: c};
	});
var $author$project$Api$Update = F2(
	function (seed, events) {
		return {events: events, seed: seed};
	});
var $author$project$Api$decodeUpdate = A3(
	$elm$json$Json$Decode$map2,
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'last_event',
							$elm$json$Json$Encode$int(r.lastEventId))
						]))),
...
var $author$project$Game$longPollEvents = F2(
	function (m, toMsg) {
		return $author$project$Api$longPollEvents(
			{
				...
				toMsg: function (x) {
					return toMsg(
						A3($author$project$Game$LongPoll, m.id, m.seed, x));
				},
...
var $author$project$Game$init = F4(
	function (state, user, client, toMsg) {
		var model = A3(
			$elm$core$List$foldl,
			$author$project$Game$applyEvent,
			{
							...
							F3(
								function (w, l1, l2) {
									return _Utils_Tuple3(
										w,
										_Utils_Tuple2(false, l1),
										_Utils_Tuple2(false, l2));
								}),
							state.words,
							state.oneLayout,
							state.twoLayout))),
				...
				player: {side: $elm$core$Maybe$Nothing, user: user},
		...
		var modelWithPlayer = _Utils_update(
			model,
			{player: player});
		return _Utils_Tuple2(
			modelWithPlayer,
...
var $author$project$Game$applyUpdate = F3(
	function (model, up, toMsg) {
		if (!_Utils_eq(up.seed, model.seed)) {
			return $elm$core$Maybe$Nothing;
		} else {
			...
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					newModel,
					(_Utils_cmp(
						$author$project$Game$lastEvent(newModel),
						$author$project$Game$lastEvent(model)) > 0) ? A2($author$project$Game$jumpToBottom, 'events', toMsg) : $elm$core$Platform$Cmd$none));
		}
	});
...
var $author$project$Cell$isExposed = F2(
	function (side, cell) {
		if (side.$ === 'A') {
			return cell.a.a;
		} else {
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'index',
							$elm$json$Json$Encode$int(r.index)),
							_Utils_Tuple2(
							'player_id',
							$elm$json$Json$Encode$string(r.player.user.id)),
							_Utils_Tuple2(
		...
		switch (msg.$) {
			...
			case 'LongPoll':
				...
				var _v1 = _Utils_Tuple2(
					_Utils_eq(id, model.id) && _Utils_eq(seed, model.seed),
					result);
				if (!_v1.a) {
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
					...
					if (_v1.b.$ === 'Err') {
						...
						return $elm$core$Maybe$Just(
							_Utils_Tuple2(
								model,
								A2($author$project$Game$longPollEvents, model, toMsg)));
					} else {
						var up = _v1.b.a;
						return A2(
							$elm$core$Maybe$map,
				...
				if (_v3.$ === 'Nothing') {
					...
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							model,
							(!A2(
								$author$project$Cell$isExposed,
								$author$project$Side$opposite(side),
								cell)) ? $author$project$Api$submitGuess(
								{
									client: model.client,
									gameId: model.id,
									index: cell.index,
									...
									toMsg: function (x) {
										return toMsg(
											$author$project$Game$GameUpdate(x));
									}
								}) : $elm$core$Platform$Cmd$none));
				}
			default:
				var _v4 = _Utils_Tuple2(
					model.turn,
					_Utils_eq(model.turn, model.player.side));
				if ((_v4.a.$ === 'Just') && _v4.b) {
					var side = _v4.a.a;
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							model,
							$author$project$Api$endTurn(
								{
									client: model.client,
									gameId: model.id,
									player: model.player,
									seed: model.seed,
									toMsg: $elm$core$Basics$always(
										toMsg($author$project$Game$NoOp))
								})));
				} else {
					return $elm$core$Maybe$Just(
			...
			switch (_v0.a.$) {
				...
				case 'NextGame':
					if (_v0.b.$ === 'GameInProgress') {
						...
						var game = _v4.a;
						return A3(
							$author$project$Main$stepGameView,
							model,
							game.id,
							$elm$core$Maybe$Just(game.seed));
					} else {
						break _v0$16;
					}
				case 'GameUpdate':
					if (_v0.b.$ === 'GameInProgress') {
						...
						if (_v6.$ === 'Just') {
							...
							return A3($author$project$Main$stepGameView, model, game.id, $elm$core$Maybe$Nothing);
						}
					} else {
						break _v0$16;
					}
								...
								_Utils_update(
									model,
									{
										page: A3(
											...
											g,
											message,
											$author$project$Main$ShowSettings(
					...
					if (_v0.a.a.$ === 'Ok') {
						switch (_v0.b.$) {
							...
							case 'GameLoading':
								var state = _v0.a.a.a;
								var id = _v0.b.a;
								var _v11 = A4($author$project$Game$init, state, model.user, model.apiClient, $author$project$Main$GameUpdate);
								var gameModel = _v11.a;
								var gameCmd = _v11.b;
								return _Utils_Tuple2(
									_Utils_update(
										model,
...
var $author$project$Cell$timeTokenIcon = F2(
	function (viewerSide, side) {
		if (viewerSide.$ === 'Nothing') {
					...
					$author$project$Cell$condList(
						_List_fromArray(
							[
								...
								true),
								_Utils_Tuple2(
								$elm$html$Html$Attributes$class('pickable'),
								pickable),
								_Utils_Tuple2(
								...
								A2(
									...
									_List_fromArray(
										[
											...
											A2($author$project$Cell$timeTokenIcon, viewerSide, $author$project$Side$B))
										]),
									_List_Nil),
								guessedA),
								_Utils_Tuple2(
								A2(
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$class(
											A2($author$project$Cell$timeTokenIcon, viewerSide, $author$project$Side$A))
										]),
									_List_Nil),
								guessedB),
								_Utils_Tuple2(
			...
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2(
						'no-team',
						_Utils_eq(model.player.side, $elm$core$Maybe$Nothing)),
...
var $author$project$Main$viewButtonRow = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Main$getSubChat = F2(
	function (idx, messageArray) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Array$get, idx, messageArray));
	});
...
var $author$project$Main$setField = F3(
	function (idx, messageArray, message) {
...
var $author$project$Game$viewEvent = F2(
	function (model, e) {
		var _v0 = e.typ;
		switch (_v0) {
			case 'join_side':
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$text(
											$author$project$Side$toString(s)),
											...
											_List_fromArray(
												[
													...
													$author$project$Color$toString(
														A2($author$project$Cell$oppColor, s, c)))
												]),
											_List_fromArray(
												[
					...
					_List_fromArray(
						[
							...
							A2(
								$elm$core$Maybe$withDefault,
								'',
								A2($elm$core$Array$get, 0, e.message)))
						]));
			case 'end_turn':
				var _v2 = e.side;
				if (_v2.$ === 'Nothing') {
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Side '),
								$elm$html$Html$text(
								$author$project$Side$toString(side)),
...
var $author$project$Game$viewWelcomeMessage = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Please copy the following 3 lines into MTurk when you are done!')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Your Username is: ' + model.player.user.name)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Your User ID is: ' + model.player.user.id)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Your Game ID is: ' + model.id)
					]))
			]));
};
var $author$project$Game$viewEvents = function (model) {
	return A3(
		...
		A2(
			...
			_Utils_Tuple2(
				'Welcome',
				$author$project$Game$viewWelcomeMessage(model)),
			A2(
				$elm$core$List$map,
				function (e) {
					return _Utils_Tuple2(
						$elm$core$String$fromInt(e.number),
						A3($elm$html$Html$Lazy$lazy2, $author$project$Game$viewEvent, model, e));
				},
				$elm$core$List$reverse(model.events))));
};
var $author$project$Main$viewEventBox = F3(
	function (g, side, chatMessage) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$author$project$Game$viewEvents(g)),
					A2(
					$elm$html$Html$form,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$value(
											A2($author$project$Main$getSubChat, 0, chatMessage)),
											$elm$html$Html$Events$onInput(
											A2($author$project$Main$setField, 0, chatMessage))
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$value(
											A2($author$project$Main$getSubChat, 1, chatMessage)),
											$elm$html$Html$Events$onInput(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$value(
											A2($author$project$Main$getSubChat, 3, chatMessage)),
											$elm$html$Html$Events$onInput(
...
var $author$project$Game$ShowKeycard = {$: 'ShowKeycard'};
var $author$project$Game$ToggleKeyView = function (a) {
	return {$: 'ToggleKeyView', a: a};
};
...
var $author$project$Game$viewKeycard = F2(
	function (model, side) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
					...
					if (_v0.$ === 'ShowWords') {
						...
						var cellsOf = function (color) {
							return A2(
								...
								function (c) {
									return _Utils_eq(
										A2($author$project$Cell$sideColor, side, c),
										color);
								},
								cells);
						};
						return A2(
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onClick(
									$author$project$Game$ToggleKeyView($author$project$Game$ShowKeycard))
								]),
							_List_fromArray(
								[
									A2(
													...
													[
														...
														_List_fromArray(
															[
																_Utils_Tuple2(
																'crossed',
																$author$project$Cell$isExposedAll(x))
															]))
													]),
												_List_fromArray(
													[
													...
													[
														...
														_List_fromArray(
															[
																_Utils_Tuple2(
																'crossed',
																A2($author$project$Cell$isExposed, side, x) || $author$project$Cell$isExposedAll(x))
															]))
													]),
												_List_fromArray(
													[
									...
									A2(
										...
										A2(
											$elm$core$List$take,
											7,
											cellsOf($author$project$Color$Tan)))),
									A2(
									$elm$html$Html$ul,
									_List_fromArray(
										[
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onClick(
									$author$project$Game$ToggleKeyView($author$project$Game$ShowWords))
								]),
							A2(
								$elm$core$List$map,
								function (c) {
											...
											[
												...
												_List_fromArray(
													[
														...
														_Utils_Tuple2(
														'crossed',
														A2($author$project$Cell$isExposed, side, c) || $author$project$Cell$isExposedAll(c))
													]))
											]),
										_List_Nil);
								},
...
var $author$project$Game$Start = {$: 'Start'};
...
var $author$project$Game$remainingGreen = function (cells) {
	return 15 - $elm$core$Array$length(
		A2(
...
var $author$project$Game$status = function (g) {
	...
	var _v0 = g.turn;
	if (_v0.$ === 'Nothing') {
		return $author$project$Game$Start;
	} else {
		var turn = _v0.a;
		return $author$project$Game$exposedBlack(
			$elm$core$Array$toList(g.cells)) ? $author$project$Game$Lost(greens) : ((!greens) ? $author$project$Game$Won(g.tokensConsumed) : A3($author$project$Game$InProgress, turn, greens, g.tokensConsumed));
	}
};
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$elm$core$String$fromInt(greens)),
									A2(
									$elm$html$Html$span,
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$elm$core$String$fromInt(tokensConsumed)),
									$elm$html$Html$text(' '),
									A2(
									$elm$html$Html$i,
									_List_fromArray(
...
var $author$project$Main$viewActiveSidebar = F3(
	function (g, side, chatMessage) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$map,
				$author$project$Main$GameUpdate,
				A2($elm$html$Html$Lazy$lazy, $author$project$Game$viewStatus, g)),
				A2(
				$elm$html$Html$map,
				$author$project$Main$GameUpdate,
				A3($elm$html$Html$Lazy$lazy2, $author$project$Game$viewKeycard, g, side)),
...
var $author$project$Main$viewJoinASide = F2(
	function (a, b) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Main$PickSide($author$project$Side$A))
								]),
							_List_fromArray(
								[
									A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Main$PickSide($author$project$Side$B))
								]),
							_List_fromArray(
								[
									A2(
...
var $author$project$Main$viewSettings = F2(
	function (g, settings) {
		return _List_fromArray(
			[
				A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Events$onInput(
												function (x) {
													return $author$project$Main$SettingsEdit(
														function (s) {
															return _Utils_update(
																s,
																{name: x});
												...
												$author$project$Main$SaveSettings(settings))
											]),
										_List_Nil)
									]))
							]))
...
var $author$project$Main$viewSidebar = F3(
	function (g, chatMessage, gameView) {
		var sides = $elm$core$Dict$values(g.players);
		var playersOnSideB = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (x) {
				...
				sides));
		var playersOnSideA = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (x) {
...
var $author$project$Main$viewGameInProgress = F3(
	function (g, chatMessage, gameView) {
		return A2(
			$author$project$Main$viewLayout,
			$elm$core$Maybe$Nothing,
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$map,
						$author$project$Main$GameUpdate,
						$author$project$Game$viewBoard(g)),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
			...
			_List_fromArray(
				[
					...
					_Utils_update(
						...
						{color: '#b7ec8a', size: 100}),
					$perzanko$elm_loading$Loading$On)
				]))
		]);
};
var $author$project$Main$SubmitNewGame = {$: 'SubmitNewGame'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('To start a game, click \'Play\'.')
							])),
						A2(
						$elm$html$Html$form,
						_List_fromArray(
...
var $author$project$Main$viewNotFound = A2(
	$author$project$Main$viewLayout,
	$elm$core$Maybe$Just('Page not found'),
	A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
},{"./main.css":"main.css","./Main.elm":"Main.elm"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
