...
})({"K6oNp":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
},{"./main.css":"5d8d2","./Main.elm":"4XkAe"}],"5d8d2":[function() {},{}],"4XkAe":[function(require,module,exports) {
(function(scope) {
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$User$User = F2(function(id, name) {
        return {
            id: id,
            name: name
        };
    ...
    var $author$project$User$decoder = A3($elm$json$Json$Decode$map2, $author$project$User$User, A2($elm$json$Json$Decode$field, 'player_id', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
    var $author$project$User$decode = function(value) {
        return A2($elm$core$Result$andThen, $elm$json$Json$Decode$decodeString($author$project$User$decoder), A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$string, value));
    };
    var $author$project$Api$init = function(url) {
            ...
            switch(_v0){
                case 'localhost':
                    return _Utils_update(url, {
                        ...
                        path: '',
                        port_: $elm$core$Maybe$Just(8080),
                        query: $elm$core$Maybe$Nothing
                    });
                case 'www.codenamesgreen.com':
                    return _Utils_update(url, {
                        fragment: $elm$core$Maybe$Nothing,
                        host: 'api.codenamesgreen.com',
                        path: '',
                        query: $elm$core$Maybe$Nothing
                    });
                default:
    ...
    var $author$project$Main$IndexData = function(a) {
        return {
            $: 'IndexData',
            a: a
        };
    ...
    var $author$project$Main$NullRoute = {
        $: 'NullRoute'
    };
    var $author$project$Api$Index = function(autogeneratedId) {
        return {
            autogeneratedId: autogeneratedId
        };
    };
    var $author$project$Api$decodeIndex = A2($elm$json$Json$Decode$map, $author$project$Api$Index, A2($elm$json$Json$Decode$field, 'autogenerated_id', $elm$json$Json$Decode$string));
    ...
    var $author$project$Api$endpointUrl = F2(function(baseUrl, path) {
        return $elm$url$Url$toString(_Utils_update(baseUrl, {
            path: path
        }));
    });
    ...
    var $author$project$Api$index = F2(function(client, toMsg) {
        return $elm$http$Http$post({
            body: $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_Nil)),
            expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Api$decodeIndex),
            url: A2($author$project$Api$endpointUrl, client.baseUrl, '/index')
        });
    });
    ...
    var $author$project$Main$GameView = function(a) {
        return {
            $: 'GameView',
            a: a
        };
    };
    var $author$project$Main$Index = {
        $: 'Index'
    };
    ...
    var $author$project$Main$route = $elm$url$Url$Parser$oneOf(_List_fromArray([
        A2($elm$url$Url$Parser$map, $author$project$Main$Index, $elm$url$Url$Parser$top),
        A2($elm$url$Url$Parser$map, $author$project$Main$GameView, $elm$url$Url$Parser$string)
    ]));
    var $author$project$Main$GameLoading = function(a) {
        return {
            $: 'GameLoading',
            a: a
        };
    ...
    var $author$project$Api$GameState = F6(function(id, seed, words, events, oneLayout, twoLayout) {
        return {
            events: events,
            id: id,
            oneLayout: oneLayout,
    ...
    var $author$project$Color$Black = {
        $: 'Black'
    };
    var $author$project$Color$Green = {
        $: 'Green'
    };
    var $author$project$Color$Tan = {
        $: 'Tan'
    };
    var $elm$json$Json$Decode$andThen = _Json_andThen;
    var $elm$json$Json$Decode$fail = _Json_fail;
    var $author$project$Color$decode = A2($elm$json$Json$Decode$andThen, function(s) {
        switch(s){
            case 't':
                return $elm$json$Json$Decode$succeed($author$project$Color$Tan);
            case 'g':
                return $elm$json$Json$Decode$succeed($author$project$Color$Green);
            case 'b':
                return $elm$json$Json$Decode$succeed($author$project$Color$Black);
            default:
                return $elm$json$Json$Decode$fail('unrecognized color');
        }
    }, $elm$json$Json$Decode$string);
    var $author$project$Api$Event = F7(function(number, typ, playerId, name, side, index, message) {
        return {
            index: index,
            message: message,
            name: name,
    ...
    var $author$project$Side$A = {
        $: 'A'
    };
    var $author$project$Side$B = {
        $: 'B'
    };
    var $author$project$Side$decodeMaybe = A2($elm$json$Json$Decode$andThen, function(i) {
        switch(i){
            case 1:
                return $elm$json$Json$Decode$succeed($elm$core$Maybe$Just($author$project$Side$A));
            case 2:
                return $elm$json$Json$Decode$succeed($elm$core$Maybe$Just($author$project$Side$B));
            default:
                return $elm$json$Json$Decode$succeed($elm$core$Maybe$Nothing);
        }
    }, $elm$json$Json$Decode$int);
    var $elm$json$Json$Decode$map7 = _Json_map7;
    var $author$project$Api$decodeEvent = A8($elm$json$Json$Decode$map7, $author$project$Api$Event, A2($elm$json$Json$Decode$field, 'number', $elm$json$Json$Decode$int), A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'player_id', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'team', $author$project$Side$decodeMaybe), A2($elm$json$Json$Decode$field, 'index', $elm$json$Json$Decode$int), A2($elm$json$Json$Decode$field, 'message', $elm$json$Json$Decode$string));
    var $elm$json$Json$Decode$map6 = _Json_map6;
    var $author$project$Api$decoderGameState = function(id) {
        return A7($elm$json$Json$Decode$map6, $author$project$Api$GameState, $elm$json$Json$Decode$succeed(id), A2($elm$json$Json$Decode$field, 'state', A2($elm$json$Json$Decode$field, 'seed', $elm$json$Json$Decode$string)), A2($elm$json$Json$Decode$field, 'words', $elm$json$Json$Decode$list($elm$json$Json$Decode$string)), A2($elm$json$Json$Decode$field, 'state', A2($elm$json$Json$Decode$field, 'events', $elm$json$Json$Decode$list($author$project$Api$decodeEvent))), A2($elm$json$Json$Decode$field, 'one_layout', $elm$json$Json$Decode$list($author$project$Color$decode)), A2($elm$json$Json$Decode$field, 'two_layout', $elm$json$Json$Decode$list($author$project$Color$decode)));
    };
    var $elm$json$Json$Encode$null = _Json_encodeNull;
    var $author$project$Api$maybeMakeGame = function(r) {
        return $elm$http$Http$post({
            body: $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2('game_id', $elm$json$Json$Encode$string(r.gameId)),
                _Utils_Tuple2('prev_seed', function() {
                    var _v0 = r.prevSeed;
                    if (_v0.$ === 'Nothing') return $elm$json$Json$Encode$null;
                    else {
                        var seed = _v0.a;
                        return $elm$json$Json$Encode$string(seed);
                    }
                }())
            ]))),
            expect: A2($elm$http$Http$expectJson, r.toMsg, $author$project$Api$decoderGameState(r.gameId)),
            url: A2($author$project$Api$endpointUrl, r.client.baseUrl, '/new-game')
        });
    };
    var $author$project$Main$stepGameView = F3(function(model, id, prevSeed) {
        return _Utils_Tuple2(_Utils_update(model, {
            ...
            gameId: id,
            prevSeed: prevSeed,
            toMsg: $author$project$Main$GotGame
        }));
    });
    var $author$project$Main$stepUrl = F2(function(url, model) {
        var _v0 = A2($elm$core$Maybe$withDefault, $author$project$Main$NullRoute, A2($elm$url$Url$Parser$parse, $author$project$Main$route, url));
        switch(_v0.$){
            case 'NullRoute':
                return _Utils_Tuple2(_Utils_update(model, {
            ...
            case 'Index':
                ...
                }), A2($author$project$Api$index, model.apiClient, $author$project$Main$IndexData));
            default:
                var id = _v0.a;
                return A3($author$project$Main$stepGameView, model, id, $elm$core$Maybe$Nothing);
        }
    });
    var $author$project$Main$init = F3(function(encodedUser, url, key) {
        var _v0 = $author$project$User$decode(encodedUser);
        if (_v0.$ === 'Err') {
            var e = _v0.a;
            return _Utils_Tuple2({
                apiClient: $author$project$Api$init(url),
                key: key,
                page: $author$project$Main$Error($elm$json$Json$Decode$errorToString(e)),
                user: A2($author$project$User$User, '', '')
            }, $elm$core$Platform$Cmd$none);
        } else {
            var user = _v0.a;
            return A2($author$project$Main$stepUrl, url, {
                apiClient: $author$project$Api$init(url),
                key: key,
                page: $author$project$Main$Home(''),
                user: user
    ...
    var $author$project$Main$GameInProgress = F3(function(a, b, c) {
        return {
            $: 'GameInProgress',
            a: a,
            b: b,
    ...
    var $author$project$Main$GameUpdate = function(a) {
        return {
            $: 'GameUpdate',
            a: a
        };
    ...
    var $author$project$Main$ShowDefault = {
        $: 'ShowDefault'
    };
    ...
    var $author$project$Side$encode = function(side) {
        return $elm$json$Json$Encode$int(function() {
            if (side.$ === 'A') return 1;
            else return 2;
        }());
    };
    var $author$project$Side$encodeMaybe = function(m) {
        if (m.$ === 'Just') {
            var s = m.a;
            return $author$project$Side$encode(s);
        } else return $elm$json$Json$Encode$int(0);
    };
    ...
    var $elm$http$Http$expectWhatever = function(toMsg) {
        return A2($elm$http$Http$expectBytesResponse, toMsg, $elm$http$Http$resolve(function(_v0) {
            return $elm$core$Result$Ok(_Utils_Tuple0);
        }));
    };
    var $author$project$Api$chat = function(r) {
        return $elm$http$Http$post({
            body: $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2('game_id', $elm$json$Json$Encode$string(r.gameId)),
                _Utils_Tuple2('seed', $elm$json$Json$Encode$string(r.seed)),
                _Utils_Tuple2('player_id', $elm$json$Json$Encode$string(r.player.user.id)),
                _Utils_Tuple2('name', $elm$json$Json$Encode$string(r.player.user.name)),
                _Utils_Tuple2('team', $author$project$Side$encodeMaybe(r.player.side)),
                _Utils_Tuple2('message', $elm$json$Json$Encode$string(r.message))
            ]))),
            expect: $elm$http$Http$expectWhatever(r.toMsg),
            url: A2($author$project$Api$endpointUrl, r.client.baseUrl, '/chat')
        });
    };
    var $author$project$Cell$Cell = F4(function(index, word, a, b) {
        return {
            a: a,
            b: b,
            index: index,
    ...
    var $author$project$Game$ShowWords = {
        $: 'ShowWords'
    };
    var $author$project$Cell$ExposedGreen = {
        $: 'ExposedGreen'
    };
    ...
    var $author$project$Cell$ExposedBlack = {
        $: 'ExposedBlack'
    };
    var $author$project$Cell$Hidden = F2(function(a, b) {
        return {
            $: 'Hidden',
            a: a,
            b: b
    ...
    var $author$project$Cell$display = function(cell) {
        var _v0 = _Utils_Tuple2(cell.a, cell.b);
        _v0$0: while(true){
            _v0$1: while(true){
                _v0$2: while(true){
                    _v0$3: while(true){
                        _v0$4: while(true)if (_v0.a.a) {
                            if (_v0.b.a) switch(_v0.a.b.$){
                                case 'Black':
                                    break _v0$0;
                                case 'Green':
                                    switch(_v0.b.b.$){
                        ...
                        var _v10 = _v0.b;
                        var exposedB = _v10.a;
                        return A2($author$project$Cell$Hidden, exposedA, exposedB);
                    }
                    var _v7 = _v0.b;
                    var _v8 = _v7.b;
                    return $author$project$Cell$ExposedGreen;
                }
                var _v5 = _v0.a;
                var _v6 = _v5.b;
                return $author$project$Cell$ExposedGreen;
            ...
            var _v3 = _v0.b;
            var _v4 = _v3.b;
            return $author$project$Cell$ExposedBlack;
        }
        var _v1 = _v0.a;
        var _v2 = _v1.b;
        return $author$project$Cell$ExposedBlack;
    ...
    var $author$project$Cell$sideColor = F2(function(side, cell) {
        if (side.$ === 'A') return cell.a.b;
        else return cell.b.b;
    });
    var $author$project$Game$hasHiddenGreens = F2(function(side, cells) {
        return A2($elm$core$List$any, function(x) {
            return _Utils_eq(A2($author$project$Cell$sideColor, side, x), $author$project$Color$Green);
        }, A2($elm$core$List$filter, function(x) {
            return !_Utils_eq($author$project$Cell$display(x), $author$project$Cell$ExposedGreen);
        }, $elm$core$Array$toList(cells)));
    });
    var $author$project$Side$opposite = function(side) {
        if (side.$ === 'A') return $author$project$Side$B;
        else return $author$project$Side$A;
    };
    var $author$project$Cell$oppColor = F2(function(side, cell) {
        return A2($author$project$Cell$sideColor, $author$project$Side$opposite(side), cell);
    });
    ...
    var $author$project$Cell$tapped = F2(function(side, cell) {
        if (side.$ === 'B') return _Utils_update(cell, {
            a: _Utils_Tuple2(true, cell.a.b)
        });
        else return _Utils_update(cell, {
            b: _Utils_Tuple2(true, cell.b.b)
        });
    });
    var $author$project$Game$applyGuess = F4(function(e, cell, side, model) {
        if (_Utils_eq(model.turn, $elm$core$Maybe$Just($author$project$Side$opposite(side)))) return _Utils_update(model, {
            events: A2($elm$core$List$cons, e, model.events)
        });
        else {
            var updatedCells = A3($elm$core$Array$set, e.index, A2($author$project$Cell$tapped, side, cell), model.cells);
            var _v0 = A2($author$project$Cell$oppColor, side, cell);
            switch(_v0.$){
                case 'Tan':
                    return _Utils_update(model, {
                        cells: updatedCells,
                        ...
                        turn: A2($author$project$Game$hasHiddenGreens, side, updatedCells) ? $elm$core$Maybe$Just($author$project$Side$opposite(side)) : $elm$core$Maybe$Just(side)
                    });
                case 'Green':
                    return A2($author$project$Game$hasHiddenGreens, $author$project$Side$opposite(side), updatedCells) ? _Utils_update(model, {
                        cells: updatedCells,
                        events: A2($elm$core$List$cons, e, model.events),
                        guessesThisTurn: model.guessesThisTurn + 1,
                        turn: $elm$core$Maybe$Just(side)
                    }) : _Utils_update(model, {
                        cells: updatedCells,
                        events: A2($elm$core$List$cons, e, model.events),
                        guessesThisTurn: 0,
                        tokensConsumed: model.tokensConsumed + 1,
                        turn: $elm$core$Maybe$Just($author$project$Side$opposite(side))
                    });
                default:
                    return _Utils_update(model, {
                        cells: updatedCells,
    ...
    var $author$project$Game$lastEvent = function(m) {
        return A2($elm$core$Maybe$withDefault, 0, A2($elm$core$Maybe$map, function(x) {
            return x.number;
        }, $elm$core$List$head(m.events)));
    };
    var $author$project$Game$applyEvent = F2(function(e, model) {
        if (_Utils_cmp(e.number, $author$project$Game$lastEvent(model)) < 1) return model;
        else {
            var _v0 = e.typ;
            switch(_v0){
                case 'join_side':
                    return _Utils_update(model, {
                        events: A2($elm$core$List$cons, e, model.events),
                        players: A3($elm$core$Dict$update, e.playerId, function(_v1) {
                            return e.side;
                        }, model.players)
                    });
                case 'player_left':
                    return _Utils_update(model, {
                        events: A2($elm$core$List$cons, e, model.events),
                        players: A3($elm$core$Dict$update, e.playerId, function(_v2) {
                            return $elm$core$Maybe$Nothing;
                        }, model.players)
                    });
                case 'guess':
                    var _v3 = _Utils_Tuple2(A2($elm$core$Array$get, e.index, model.cells), e.side);
                    if (_v3.a.$ === 'Just' && _v3.b.$ === 'Just') {
                        var cell = _v3.a.a;
                        var side = _v3.b.a;
                        return A4($author$project$Game$applyGuess, e, cell, side, model);
                    } else return _Utils_update(model, {
                        events: A2($elm$core$List$cons, e, model.events)
                    });
                case 'end_turn':
                    var _v4 = _Utils_Tuple2(_Utils_eq(model.turn, e.side), e.side);
                    if (_v4.a && _v4.b.$ === 'Just') {
                        var side = _v4.b.a;
                        return _Utils_update(model, {
                            events: A2($elm$core$List$cons, e, model.events),
                            guessesThisTurn: 0,
                            tokensConsumed: model.tokensConsumed + 1,
                            turn: A2($author$project$Game$hasHiddenGreens, side, model.cells) ? $elm$core$Maybe$Just($author$project$Side$opposite(side)) : model.turn
                        });
                    } else return _Utils_update(model, {
                        events: A2($elm$core$List$cons, e, model.events)
                    });
    ...
    var $author$project$Game$jumpToBottom = F2(function(id, toMsg) {
        return A2($elm$core$Task$attempt, $elm$core$Basics$always(toMsg($author$project$Game$NoOp)), A2($elm$core$Task$andThen, function(info) {
            return A3($elm$browser$Browser$Dom$setViewportOf, id, 0, info.scene.height);
        }, $elm$browser$Browser$Dom$getViewportOf(id)));
    });
    var $author$project$Game$LongPoll = F3(function(a, b, c) {
        return {
            $: 'LongPoll',
            a: a,
            b: b,
    ...
    var $author$project$Api$Update = F2(function(seed, events) {
        return {
            events: events,
            seed: seed
        };
    });
    var $author$project$Api$decodeUpdate = A3($elm$json$Json$Decode$map2, $author$project$Api$Update, A2($elm$json$Json$Decode$field, 'seed', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'events', $elm$json$Json$Decode$list($author$project$Api$decodeEvent)));
    var $author$project$Api$longPollEvents = function(r) {
        return $elm$http$Http$request({
            body: $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2('game_id', $elm$json$Json$Encode$string(r.gameId)),
                _Utils_Tuple2('seed', $elm$json$Json$Encode$string(r.seed)),
                ...
                _Utils_Tuple2('name', $elm$json$Json$Encode$string(r.player.user.name)),
                _Utils_Tuple2('team', $author$project$Side$encodeMaybe(r.player.side)),
                _Utils_Tuple2('last_event', $elm$json$Json$Encode$int(r.lastEventId))
            ]))),
            expect: A2($elm$http$Http$expectJson, r.toMsg, $author$project$Api$decodeUpdate),
            headers: _List_Nil,
            method: 'POST',
            timeout: $elm$core$Maybe$Just(45000),
            tracker: $elm$core$Maybe$Just(r.tracker),
            url: A2($author$project$Api$endpointUrl, r.client.baseUrl, '/events')
        });
    };
    var $author$project$Game$longPollEvents = F2(function(m, toMsg) {
        return $author$project$Api$longPollEvents({
            client: m.client,
            gameId: m.id,
            lastEventId: $author$project$Game$lastEvent(m),
            player: m.player,
            seed: m.seed,
            toMsg: function(x) {
                return toMsg(A3($author$project$Game$LongPoll, m.id, m.seed, x));
            },
            tracker: _Utils_ap(m.id, m.seed)
        });
    });
    var $elm$core$List$map3 = _List_map3;
    var $author$project$Game$init = F4(function(state, user, client, toMsg) {
        var model = A3($elm$core$List$foldl, $author$project$Game$applyEvent, {
            cells: $elm$core$Array$fromList(A2($elm$core$List$indexedMap, F2(function(i, _v0) {
                var w = _v0.a;
                var _v1 = _v0.b;
                var e1 = _v1.a;
                var l1 = _v1.b;
                ...
                var e2 = _v2.a;
                var l2 = _v2.b;
                return A4($author$project$Cell$Cell, i, w, _Utils_Tuple2(e1, l1), _Utils_Tuple2(e2, l2));
            }), A4($elm$core$List$map3, F3(function(w, l1, l2) {
                return _Utils_Tuple3(w, _Utils_Tuple2(false, l1), _Utils_Tuple2(false, l2));
            }), state.words, state.oneLayout, state.twoLayout))),
            client: client,
            events: _List_Nil,
            guessesThisTurn: 0,
            id: state.id,
            keyView: $author$project$Game$ShowWords,
            player: {
                side: $elm$core$Maybe$Nothing,
                user: user
            },
            players: $elm$core$Dict$empty,
            seed: state.seed,
            tokensConsumed: 0,
            turn: $elm$core$Maybe$Nothing
        }, state.events);
        var player = {
            side: A2($elm$core$Dict$get, user.id, model.players),
            user: user
        };
        var modelWithPlayer = _Utils_update(model, {
            player: player
        });
        return _Utils_Tuple2(modelWithPlayer, $elm$core$Platform$Cmd$batch(_List_fromArray([
            A2($author$project$Game$longPollEvents, modelWithPlayer, toMsg),
            A2($author$project$Game$jumpToBottom, 'events', toMsg)
        ])));
    });
    var $elm$browser$Browser$Navigation$load = _Browser_load;
    var $author$project$Api$ping = function(r) {
        return $elm$http$Http$post({
            body: $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2('game_id', $elm$json$Json$Encode$string(r.gameId)),
                _Utils_Tuple2('seed', $elm$json$Json$Encode$string(r.seed)),
            ...
            expect: $elm$http$Http$expectWhatever(r.toMsg),
            url: A2($author$project$Api$endpointUrl, r.client.baseUrl, '/ping')
        });
    };
    ...
    var $elm$url$Url$Builder$relative = F2(function(pathSegments, parameters) {
        return _Utils_ap(A2($elm$core$String$join, '/', pathSegments), $elm$url$Url$Builder$toQuery(parameters));
    });
    var $author$project$Game$GameUpdate = function(a) {
        return {
            $: 'GameUpdate',
            a: a
        };
    };
    var $author$project$Game$applyUpdate = F3(function(model, up, toMsg) {
        if (!_Utils_eq(up.seed, model.seed)) return $elm$core$Maybe$Nothing;
        else {
            var newModel = A3($elm$core$List$foldl, $author$project$Game$applyEvent, model, up.events);
            return $elm$core$Maybe$Just(_Utils_Tuple2(newModel, _Utils_cmp($author$project$Game$lastEvent(newModel), $author$project$Game$lastEvent(model)) > 0 ? A2($author$project$Game$jumpToBottom, 'events', toMsg) : $elm$core$Platform$Cmd$none));
        }
    });
    var $author$project$Api$endTurn = function(r) {
        return $elm$http$Http$post({
            body: $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2('game_id', $elm$json$Json$Encode$string(r.gameId)),
                _Utils_Tuple2('seed', $elm$json$Json$Encode$string(r.seed)),
            ...
            expect: $elm$http$Http$expectWhatever(r.toMsg),
            url: A2($author$project$Api$endpointUrl, r.client.baseUrl, '/end-turn')
        });
    };
    var $author$project$Cell$isExposed = F2(function(side, cell) {
        if (side.$ === 'A') return cell.a.a;
        else return cell.b.a;
    });
    var $author$project$Api$submitGuess = function(r) {
        return $elm$http$Http$post({
            body: $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2('game_id', $elm$json$Json$Encode$string(r.gameId)),
                _Utils_Tuple2('seed', $elm$json$Json$Encode$string(r.seed)),
                _Utils_Tuple2('index', $elm$json$Json$Encode$int(r.index)),
                _Utils_Tuple2('player_id', $elm$json$Json$Encode$string(r.player.user.id)),
                _Utils_Tuple2('name', $elm$json$Json$Encode$string(r.player.user.name)),
                _Utils_Tuple2('team', $author$project$Side$encodeMaybe(r.player.side)),
                _Utils_Tuple2('last_event', $elm$json$Json$Encode$int(r.lastEventId))
            ...
            expect: A2($elm$http$Http$expectJson, r.toMsg, $author$project$Api$decodeUpdate),
            url: A2($author$project$Api$endpointUrl, r.client.baseUrl, '/guess')
        });
    };
    var $author$project$Game$update = F3(function(msg, model, toMsg) {
        switch(msg.$){
            case 'NoOp':
                return $elm$core$Maybe$Just(_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
            case 'LongPoll':
                var id = msg.a;
                var seed = msg.b;
                var result = msg.c;
                var _v1 = _Utils_Tuple2(_Utils_eq(id, model.id) && _Utils_eq(seed, model.seed), result);
                if (!_v1.a) return $elm$core$Maybe$Just(_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
                else if (_v1.b.$ === 'Err') {
                    var e = _v1.b.a;
                    return $elm$core$Maybe$Just(_Utils_Tuple2(model, A2($author$project$Game$longPollEvents, model, toMsg)));
                } else {
                    var up = _v1.b.a;
                    return A2($elm$core$Maybe$map, function(_v2) {
                        var m = _v2.a;
                        var cmd = _v2.b;
                        return _Utils_Tuple2(m, $elm$core$Platform$Cmd$batch(_List_fromArray([
                            cmd,
                            A2($author$project$Game$longPollEvents, m, toMsg)
                        ])));
                    }, A3($author$project$Game$applyUpdate, model, up, toMsg));
                }
            case 'GameUpdate':
                if (msg.a.$ === 'Ok') {
                    var up = msg.a.a;
                    return A3($author$project$Game$applyUpdate, model, up, toMsg);
                } else {
                    var err = msg.a.a;
                    return $elm$core$Maybe$Just(_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
                }
            case 'ToggleKeyView':
                ...
                return $elm$core$Maybe$Just(_Utils_Tuple2(_Utils_update(model, {
                    keyView: newSetting
                }), $elm$core$Platform$Cmd$none));
            case 'WordPicked':
                var cell = msg.a;
                var _v3 = model.player.side;
                if (_v3.$ === 'Nothing') return $elm$core$Maybe$Just(_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
                else {
                    var side = _v3.a;
                    return $elm$core$Maybe$Just(_Utils_Tuple2(model, !A2($author$project$Cell$isExposed, $author$project$Side$opposite(side), cell) ? $author$project$Api$submitGuess({
                        client: model.client,
                        gameId: model.id,
                        index: cell.index,
                        lastEventId: $author$project$Game$lastEvent(model),
                        player: model.player,
                        seed: model.seed,
                        toMsg: function(x) {
                            return toMsg($author$project$Game$GameUpdate(x));
                        }
                    }) : $elm$core$Platform$Cmd$none));
                }
            default:
                var _v4 = _Utils_Tuple2(model.turn, _Utils_eq(model.turn, model.player.side));
                if (_v4.a.$ === 'Just' && _v4.b) {
                    var side = _v4.a.a;
                    return $elm$core$Maybe$Just(_Utils_Tuple2(model, $author$project$Api$endTurn({
                        client: model.client,
                        gameId: model.id,
                        player: model.player,
                        seed: model.seed,
                        toMsg: $elm$core$Basics$always(toMsg($author$project$Game$NoOp))
                    })));
                } else return $elm$core$Maybe$Just(_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
        }
    });
        ...
        _v0$15: while(true)switch(_v0.a.$){
            case 'LinkClicked':
                ...
                if (urlRequest.$ === 'Internal') {
                    ...
                    return _Utils_Tuple2(model, A2($elm$browser$Browser$Navigation$pushUrl, model.key, $elm$url$Url$toString(url)));
                } else {
            ...
            case 'IndexData':
                if (_v0.a.a.$ === 'Ok' && _v0.b.$ === 'Home') {
                    var data = _v0.a.a.a;
                    var id = _v0.b.a;
                    return _Utils_Tuple2(id === '' ? _Utils_update(model, {
                        page: $author$project$Main$Home(data.autogeneratedId)
            ...
            case 'IdChanged':
                if (_v0.b.$ === 'Home') {
                    var id = _v0.a.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        page: $author$project$Main$Home(id)
                    }), $elm$core$Platform$Cmd$none);
                } else break _v0$15;
            case 'SubmitNewGame':
                if (_v0.b.$ === 'Home') {
                    var _v2 = _v0.a;
                    var id = _v0.b.a;
                    return _Utils_Tuple2(model, A2($elm$browser$Browser$Navigation$pushUrl, model.key, A2($elm$url$Url$Builder$relative, _List_fromArray([
                        id
                    ]), _List_Nil)));
                } else break _v0$15;
            case 'NextGame':
                if (_v0.b.$ === 'GameInProgress') {
                    ...
                    var _v4 = _v0.b;
                    var game = _v4.a;
                    return A3($author$project$Main$stepGameView, model, game.id, $elm$core$Maybe$Just(game.seed));
                } else break _v0$15;
            case 'GameUpdate':
                if (_v0.b.$ === 'GameInProgress') {
                    var gameMsg = _v0.a.a;
                    ...
                    var chat = _v5.b;
                    var gameView = _v5.c;
                    var _v6 = A3($author$project$Game$update, gameMsg, game, $author$project$Main$GameUpdate);
                    if (_v6.$ === 'Just') {
                        var _v7 = _v6.a;
                        var newGame = _v7.a;
                        var gameCmd = _v7.b;
                        return _Utils_Tuple2(_Utils_update(model, {
                            page: A3($author$project$Main$GameInProgress, newGame, chat, gameView)
                        }), gameCmd);
                    } else return A3($author$project$Main$stepGameView, model, game.id, $elm$core$Maybe$Nothing);
                } else break _v0$15;
            case 'PickSide':
                if (_v0.b.$ === 'GameInProgress') {
                    var side = _v0.a.a;
                    ...
                    var chat = _v11.b;
                    var gameView = _v11.c;
                    var oldPlayer = oldGame.player;
                    var game = _Utils_update(oldGame, {
                        player: _Utils_update(oldPlayer, {
                            side: $elm$core$Maybe$Just(side)
                        })
                    });
                    return _Utils_Tuple2(_Utils_update(model, {
                        page: A3($author$project$Main$GameInProgress, game, chat, gameView)
                    }), $author$project$Api$ping({
                        client: model.apiClient,
                        gameId: game.id,
                        player: game.player,
                        seed: game.seed,
            ...
            case 'ChatMessageChanged':
                if (_v0.b.$ === 'GameInProgress') {
                    ...
                    var gameView = _v12.c;
                    return _Utils_Tuple2(_Utils_update(model, {
                        page: A3($author$project$Main$GameInProgress, g, message, gameView)
                    }), $elm$core$Platform$Cmd$none);
                } else break _v0$15;
            case 'SendChat':
                if (_v0.b.$ === 'GameInProgress') {
                    ...
                    var gameView = _v14.c;
                    return _Utils_Tuple2(_Utils_update(model, {
                        page: A3($author$project$Main$GameInProgress, g, '', gameView)
            ...
            case 'ToggleSettings':
                if (_v0.b.$ === 'GameInProgress') {
                    ...
                    var message = _v16.b;
                    var gameView = _v16.c;
                    if (gameView.$ === 'ShowSettings') return _Utils_Tuple2(_Utils_update(model, {
                        page: A3($author$project$Main$GameInProgress, g, message, $author$project$Main$ShowDefault)
                    }), $elm$core$Platform$Cmd$none);
                    else return _Utils_Tuple2(_Utils_update(model, {
                        page: A3($author$project$Main$GameInProgress, g, message, $author$project$Main$ShowSettings({
                            name: g.player.user.name
                        }))
                    }), $elm$core$Platform$Cmd$none);
                } else break _v0$15;
            case 'SettingsEdit':
                if (_v0.b.$ === 'GameInProgress' && _v0.b.c.$ === 'ShowSettings') {
                    var editSetting = _v0.a.a;
                    var _v18 = _v0.b;
                    var g = _v18.a;
                    var message = _v18.b;
                    var settings = _v18.c.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        page: A3($author$project$Main$GameInProgress, g, message, $author$project$Main$ShowSettings(editSetting(settings)))
                    }), $elm$core$Platform$Cmd$none);
                } else break _v0$15;
            case 'GotGame':
                if (_v0.a.a.$ === 'Ok') switch(_v0.b.$){
                    case 'GameInProgress':
                        var state = _v0.a.a.a;
                        var _v8 = _v0.b;
                        var old = _v8.a;
                        var chat = _v8.b;
                        var _v9 = A4($author$project$Game$init, state, model.user, model.apiClient, $author$project$Main$GameUpdate);
                        var gameModel = _v9.a;
                        var gameCmd = _v9.b;
                        return _Utils_Tuple2(_Utils_update(model, {
                            page: A3($author$project$Main$GameInProgress, gameModel, chat, $author$project$Main$ShowDefault)
                        }), gameCmd);
                    case 'GameLoading':
                        var state = _v0.a.a.a;
                        var id = _v0.b.a;
                        var _v10 = A4($author$project$Game$init, state, model.user, model.apiClient, $author$project$Main$GameUpdate);
                        var gameModel = _v10.a;
                        var gameCmd = _v10.b;
                        return _Utils_Tuple2(_Utils_update(model, {
                            page: A3($author$project$Main$GameInProgress, gameModel, '', $author$project$Main$ShowDefault)
                        }), gameCmd);
                    default:
                        break _v0$15;
                }
    ...
    var $author$project$Main$viewHeader = A2($elm$html$Html$div, _List_fromArray([
        ...
        A2($elm$html$Html$h1, _List_Nil, _List_fromArray([
            A2($elm$html$Html$a, _List_fromArray([
                ...
                $elm$html$Html$text('Codenames Green')
            ]))
        ]))
    ]));
    var $author$project$Main$viewLayout = F2(function(subtitle, content) {
        return {
            ...
            title: (function() {
                if (subtitle.$ === 'Just') {
                    var t = subtitle.a;
                    return 'Codenames Green | ' + t;
                } else return 'Codenames Green';
            })()
        };
    });
    var $author$project$Main$viewError = function(msg) {
        return A2($author$project$Main$viewLayout, $elm$core$Maybe$Just('Error'), A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$p, _List_Nil, _List_fromArray([
                $elm$html$Html$text('An unexpected error was encountered. Most likely this is the result of corrupted local storage. Try clearing all storage associated with the app.')
            ])),
            A2($elm$html$Html$p, _List_Nil, _List_fromArray([
                A2($elm$html$Html$strong, _List_Nil, _List_fromArray([
    ...
    var $author$project$Game$WordPicked = function(a) {
        return {
            $: 'WordPicked',
            a: a
        };
    ...
    var $author$project$Cell$condList = function(list) {
        return A2($elm$core$List$map, $elm$core$Tuple$first, A2($elm$core$List$filter, $elm$core$Tuple$second, list));
    };
    var $elm$html$Html$i = _VirtualDom_node('i');
    var $author$project$Cell$timeTokenIcon = F2(function(viewerSide, side) {
        if (viewerSide.$ === 'Nothing') return 'ion-ios-close-circle';
        else {
            var s = viewerSide.a;
            return _Utils_eq(s, side) ? 'ion-ios-arrow-dropdown-circle' : 'ion-ios-arrow-dropup-circle';
        }
    });
    var $author$project$Cell$view = F3(function(viewerSide, msg, cell) {
        ...
        switch(_v0.$){
            ...
            default:
                var guessedA = _v0.a;
                var guessedB = _v0.b;
                var pickable = A2($elm$core$Maybe$withDefault, false, A2($elm$core$Maybe$map, function(side) {
                    return _Utils_eq(side, $author$project$Side$A) && !guessedB || _Utils_eq(side, $author$project$Side$B) && !guessedA;
                }, viewerSide));
                return A2($elm$html$Html$div, $author$project$Cell$condList(_List_fromArray([
                    _Utils_Tuple2($elm$html$Html$Attributes$class('cell'), true),
                    _Utils_Tuple2($elm$html$Html$Attributes$class('pickable'), pickable),
                    _Utils_Tuple2($elm$html$Html$Events$onClick(msg(cell)), pickable)
                ])), $author$project$Cell$condList(_List_fromArray([
                    _Utils_Tuple2(A2($elm$html$Html$i, _List_fromArray([
                        $elm$html$Html$Attributes$class('icon time-token-a'),
                        $elm$html$Html$Attributes$class(A2($author$project$Cell$timeTokenIcon, viewerSide, $author$project$Side$B))
                    ]), _List_Nil), guessedA),
                    _Utils_Tuple2(A2($elm$html$Html$i, _List_fromArray([
                        $elm$html$Html$Attributes$class('icon time-token-b'),
                        $elm$html$Html$Attributes$class(A2($author$project$Cell$timeTokenIcon, viewerSide, $author$project$Side$A))
                    ]), _List_Nil), guessedB),
                    _Utils_Tuple2(A2($elm$html$Html$div, _List_fromArray([
    ...
    var $author$project$Game$viewBoard = function(model) {
        var isGuessing = _Utils_eq(model.turn, model.player.side) || _Utils_eq(model.turn, $elm$core$Maybe$Nothing);
        var tapMsg = isGuessing ? $author$project$Game$WordPicked : $elm$core$Basics$always($author$project$Game$NoOp);
        return A3($elm$html$Html$Keyed$node, 'div', _List_fromArray([
            ...
            $elm$html$Html$Attributes$classList(_List_fromArray([
                _Utils_Tuple2('no-team', _Utils_eq(model.player.side, $elm$core$Maybe$Nothing)),
                _Utils_Tuple2('guessing', isGuessing)
            ]))
        ]), A2($elm$core$List$map, function(c) {
            return _Utils_Tuple2(c.word, A4($elm$html$Html$Lazy$lazy3, $author$project$Cell$view, model.player.side, tapMsg, c));
        }, $elm$core$Array$toList(model.cells)));
    };
    var $elm$virtual_dom$VirtualDom$lazy2 = _VirtualDom_lazy2;
    var $elm$html$Html$Lazy$lazy2 = $elm$virtual_dom$VirtualDom$lazy2;
    var $author$project$Main$NextGame = {
        $: 'NextGame'
    };
    var $author$project$Main$viewButtonRow = A2($elm$html$Html$div, _List_fromArray([
        $elm$html$Html$Attributes$id('button-row')
    ]), _List_fromArray([
    ...
    var $author$project$Main$SendChat = {
        $: 'SendChat'
    };
    ...
    var $author$project$Side$toString = function(side) {
        if (side.$ === 'A') return 'A';
        else return 'B';
    };
    var $author$project$Game$viewEvent = F2(function(model, e) {
        var _v0 = e.typ;
        switch(_v0){
            case 'join_side':
                return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                    ...
                    $elm$html$Html$text(A2($elm$core$Maybe$withDefault, '', A2($elm$core$Maybe$map, $author$project$Side$toString, e.side))),
                    $elm$html$Html$text('.')
                ]));
            case 'player_left':
                return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                    $elm$html$Html$text(e.name),
                    $elm$html$Html$text(' has left the game.')
                ]));
            case 'guess':
                return A2($elm$core$Maybe$withDefault, $elm$html$Html$text(''), A3($elm$core$Maybe$map2, F2(function(s, c) {
                    return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        $elm$html$Html$text('Side '),
                        $elm$html$Html$text($author$project$Side$toString(s)),
                        $elm$html$Html$text(' tapped '),
                        A2($elm$html$Html$span, _List_fromArray([
                            $elm$html$Html$Attributes$class('chat-color'),
                            $elm$html$Html$Attributes$class($author$project$Color$toString(A2($author$project$Cell$oppColor, s, c)))
                        ]), _List_fromArray([
                            $elm$html$Html$text(c.word)
                        ])),
                        $elm$html$Html$text('.')
                    ]));
                }), e.side, A2($elm$core$Array$get, e.index, model.cells)));
            case 'chat':
                var sideEl = function() {
                    var _v1 = e.side;
                    if (_v1.$ === 'Just') {
            ...
            case 'end_turn':
                var _v2 = e.side;
                if (_v2.$ === 'Nothing') return $elm$html$Html$text('');
                else {
                    var side = _v2.a;
                    return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        $elm$html$Html$text('Side '),
                        $elm$html$Html$text($author$project$Side$toString(side)),
    ...
    var $author$project$Game$viewWelcomeMessage = A2($elm$html$Html$div, _List_fromArray([
        $elm$html$Html$Attributes$class('system-message')
    ]), _List_fromArray([
    ...
    var $author$project$Game$viewEvents = function(model) {
        return A3($elm$html$Html$Keyed$node, 'div', _List_fromArray([
            $elm$html$Html$Attributes$id('events')
        ]), A2($elm$core$List$cons, _Utils_Tuple2('Welcome', $author$project$Game$viewWelcomeMessage), A2($elm$core$List$map, function(e) {
            return _Utils_Tuple2($elm$core$String$fromInt(e.number), A3($elm$html$Html$Lazy$lazy2, $author$project$Game$viewEvent, model, e));
        }, $elm$core$List$reverse(model.events))));
    };
    var $author$project$Main$viewEventBox = F3(function(g, side, chatMessage) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$id('event-log')
        ]), _List_fromArray([
            A2($elm$html$Html$map, $author$project$Main$GameUpdate, $author$project$Game$viewEvents(g)),
            A2($elm$html$Html$form, _List_fromArray([
                $elm$html$Html$Attributes$id('chat-form'),
                $elm$html$Html$Events$onSubmit($author$project$Main$SendChat)
            ]), _List_fromArray([
                A2($elm$html$Html$input, _List_fromArray([
                    $elm$html$Html$Attributes$value(chatMessage),
                    $elm$html$Html$Events$onInput($author$project$Main$ChatMessageChanged)
                ]), _List_Nil),
                A2($elm$html$Html$button, _List_Nil, _List_fromArray([
                    $elm$html$Html$text('Send')
                ]))
            ]))
        ]));
    });
    var $author$project$Game$ShowKeycard = {
        $: 'ShowKeycard'
    };
    var $author$project$Game$ToggleKeyView = function(a) {
        return {
            $: 'ToggleKeyView',
            a: a
        };
    };
    var $author$project$Cell$isExposedAll = function(cell) {
        var _v0 = $author$project$Cell$display(cell);
        switch(_v0.$){
            case 'ExposedGreen':
                return true;
    ...
    var $author$project$Game$viewKeycard = F2(function(model, side) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$id('key')
        ]), _List_fromArray([
            function() {
                var _v0 = model.keyView;
                if (_v0.$ === 'ShowWords') {
                    var cells = $elm$core$Array$toList(model.cells);
                    var cellsOf = function(color) {
                        return A2($elm$core$List$filter, function(c) {
                            return _Utils_eq(A2($author$project$Cell$sideColor, side, c), color);
                        }, cells);
                    };
                    return A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$id('key-list'),
                        $elm$html$Html$Events$onClick($author$project$Game$ToggleKeyView($author$project$Game$ShowKeycard))
                    ]), _List_fromArray([
                        A2($elm$html$Html$ul, _List_fromArray([
                            $elm$html$Html$Attributes$class('greens')
                        ]), A2($elm$core$List$map, function(x) {
                            return A2($elm$html$Html$li, _List_fromArray([
                                $elm$html$Html$Attributes$classList(_List_fromArray([
                                    _Utils_Tuple2('crossed', $author$project$Cell$isExposedAll(x))
                                ]))
                            ]), _List_fromArray([
                                $elm$html$Html$text(x.word)
                            ]));
                        }, cellsOf($author$project$Color$Green))),
                        A2($elm$html$Html$ul, _List_fromArray([
                            $elm$html$Html$Attributes$class('blacks')
                        ]), A2($elm$core$List$map, function(x) {
                            return A2($elm$html$Html$li, _List_fromArray([
                                $elm$html$Html$Attributes$classList(_List_fromArray([
                                    _Utils_Tuple2('crossed', A2($author$project$Cell$isExposed, side, x) || $author$project$Cell$isExposedAll(x))
                                ]))
                            ]), _List_fromArray([
                                $elm$html$Html$text(x.word)
                            ]));
                        }, cellsOf($author$project$Color$Black))),
                        A2($elm$html$Html$ul, _List_fromArray([
                            $elm$html$Html$Attributes$class('tans')
                        ]), A2($elm$core$List$map, function(x) {
                            return A2($elm$html$Html$li, _List_fromArray([
                                $elm$html$Html$Attributes$classList(_List_fromArray([
                                    _Utils_Tuple2('crossed', A2($author$project$Cell$isExposed, side, x) || $author$project$Cell$isExposedAll(x))
                        ...
                        }, A2($elm$core$List$take, 7, cellsOf($author$project$Color$Tan)))),
                        A2($elm$html$Html$ul, _List_fromArray([
                            $elm$html$Html$Attributes$class('tans')
                        ]), A2($elm$core$List$map, function(x) {
                            return A2($elm$html$Html$li, _List_fromArray([
                        ...
                        }, A2($elm$core$List$drop, 7, cellsOf($author$project$Color$Tan))))
                    ]));
                } else return A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$id('key-card'),
                    $elm$html$Html$Events$onClick($author$project$Game$ToggleKeyView($author$project$Game$ShowWords))
                ]), A2($elm$core$List$map, function(c) {
                    return A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$classList(_List_fromArray([
                            _Utils_Tuple2('cell', true),
                            _Utils_Tuple2($author$project$Color$toString(A2($author$project$Cell$sideColor, side, c)), true),
                            _Utils_Tuple2('crossed', A2($author$project$Cell$isExposed, side, c) || $author$project$Cell$isExposedAll(c))
                        ]))
                    ]), _List_Nil);
                }, $elm$core$Array$toList(model.cells)));
            }()
    ...
    var $author$project$Game$DoneGuessing = {
        $: 'DoneGuessing'
    };
    ...
    var $author$project$Game$InProgress = F3(function(a, b, c) {
        return {
            $: 'InProgress',
            a: a,
            b: b,
    ...
    var $author$project$Game$Lost = function(a) {
        return {
            $: 'Lost',
            a: a
        };
    };
    var $author$project$Game$Start = {
        $: 'Start'
    };
    ...
    var $author$project$Game$exposedBlack = function(cells) {
        return A2($elm$core$List$any, function(x) {
            return _Utils_eq(x, $author$project$Cell$ExposedBlack);
        }, A2($elm$core$List$map, $author$project$Cell$display, cells));
    };
    var $elm$core$Array$filter = F2(function(isGood, array) {
        return $elm$core$Array$fromList(A3($elm$core$Array$foldr, F2(function(x, xs) {
            return isGood(x) ? A2($elm$core$List$cons, x, xs) : xs;
        }), _List_Nil, array));
    });
    ...
    var $author$project$Game$remainingGreen = function(cells) {
        return 15 - $elm$core$Array$length(A2($elm$core$Array$filter, function(x) {
            return _Utils_eq(x, $author$project$Cell$ExposedGreen);
        }, A2($elm$core$Array$map, $author$project$Cell$display, cells)));
    };
    var $author$project$Game$status = function(g) {
        var greens = $author$project$Game$remainingGreen(g.cells);
        var _v0 = g.turn;
        if (_v0.$ === 'Nothing') return $author$project$Game$Start;
        else {
            var turn = _v0.a;
            return $author$project$Game$exposedBlack($elm$core$Array$toList(g.cells)) ? $author$project$Game$Lost(greens) : !greens ? $author$project$Game$Won(g.tokensConsumed) : A3($author$project$Game$InProgress, turn, greens, g.tokensConsumed);
        }
    };
    var $author$project$Game$viewStatus = function(model) {
        ...
        switch(_v0.$){
            ...
            case 'Lost':
                return A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$id('status'),
                    $elm$html$Html$Attributes$class('lost')
                ]), _List_fromArray([
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        $elm$html$Html$text('You lost :(')
                    ]))
                ]));
            case 'Won':
                return A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$id('status'),
                    $elm$html$Html$Attributes$class('won')
                ]), _List_fromArray([
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
            ...
            default:
                var turn = _v0.a;
                var greens = _v0.b;
                var tokensConsumed = _v0.c;
                return A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$id('status'),
                    $elm$html$Html$Attributes$class('in-progress')
                ]), A2($elm$core$List$append, _Utils_eq($elm$core$Maybe$Just(turn), model.player.side) ? A2($elm$core$List$cons, A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                    $elm$html$Html$text('You\'re guessing.')
                ])), model.guessesThisTurn > 0 ? _List_fromArray([
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        A2($elm$html$Html$button, _List_fromArray([
                            $elm$html$Html$Attributes$class('done-guessing'),
                            $elm$html$Html$Events$onClick($author$project$Game$DoneGuessing)
                        ]), _List_fromArray([
                            $elm$html$Html$text('Done guessing')
                        ]))
                    ]))
                ]) : _List_fromArray([
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        A2($elm$html$Html$button, _List_fromArray([
                            ...
                            $elm$html$Html$text('Must guess once')
                        ]))
                    ]))
                ])) : _List_fromArray([
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                    ...
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        $elm$html$Html$text($elm$core$String$fromInt(greens)),
                        A2($elm$html$Html$span, _List_fromArray([
                            $elm$html$Html$Attributes$class('green-icon')
                        ]), _List_Nil)
                    ])),
                    A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                        $elm$html$Html$text($elm$core$String$fromInt(tokensConsumed)),
                        $elm$html$Html$text(' '),
                        A2($elm$html$Html$i, _List_fromArray([
                            $elm$html$Html$Attributes$class('icon ion-ios-time')
                        ]), _List_Nil)
                    ]))
                ])));
        }
    };
    var $author$project$Main$viewActiveSidebar = F3(function(g, side, chatMessage) {
        return _List_fromArray([
            A2($elm$html$Html$map, $author$project$Main$GameUpdate, A2($elm$html$Html$Lazy$lazy, $author$project$Game$viewStatus, g)),
            A2($elm$html$Html$map, $author$project$Main$GameUpdate, A3($elm$html$Html$Lazy$lazy2, $author$project$Game$viewKeycard, g, side)),
            A4($elm$html$Html$Lazy$lazy3, $author$project$Main$viewEventBox, g, side, chatMessage),
            $author$project$Main$viewButtonRow
        ]);
    });
    var $author$project$Main$PickSide = function(a) {
        return {
            $: 'PickSide',
            a: a
        };
    ...
    var $author$project$Main$viewJoinASide = F2(function(a, b) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$id('join-a-team')
        ]), _List_fromArray([
            A2($elm$html$Html$h3, _List_Nil, _List_fromArray([
                $elm$html$Html$text('Pick a side')
            ])),
            A2($elm$html$Html$p, _List_Nil, _List_fromArray([
                $elm$html$Html$text('Pick a side to start playing. Each side has a different key card.')
            ])),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('buttons')
            ]), _List_fromArray([
                A2($elm$html$Html$button, _List_fromArray([
                    $elm$html$Html$Events$onClick($author$project$Main$PickSide($author$project$Side$A))
                ]), _List_fromArray([
                    A2($elm$html$Html$span, _List_fromArray([
                        $elm$html$Html$Attributes$class('call-to-action')
                    ]), _List_fromArray([
                    ...
                    A2($elm$html$Html$span, _List_fromArray([
                        ...
                        $elm$html$Html$text('('),
                        $elm$html$Html$text($elm$core$String$fromInt(a)),
                        $elm$html$Html$text(' players)')
                    ]))
                ])),
                A2($elm$html$Html$button, _List_fromArray([
                    $elm$html$Html$Events$onClick($author$project$Main$PickSide($author$project$Side$B))
                ]), _List_fromArray([
                    A2($elm$html$Html$span, _List_fromArray([
                        $elm$html$Html$Attributes$class('call-to-action')
                    ]), _List_fromArray([
                    ...
                    A2($elm$html$Html$span, _List_fromArray([
                        ...
                        $elm$html$Html$text('('),
                        $elm$html$Html$text($elm$core$String$fromInt(b)),
                        $elm$html$Html$text(' players)')
                    ]))
                ]))
            ]))
    ...
    var $author$project$Main$SaveSettings = function(a) {
        return {
            $: 'SaveSettings',
            a: a
        };
    };
    var $author$project$Main$SettingsEdit = function(a) {
        return {
            $: 'SettingsEdit',
            a: a
        };
    };
    var $author$project$Main$ToggleSettings = {
        $: 'ToggleSettings'
    };
    ...
    var $author$project$Main$viewSettings = F2(function(g, settings) {
        return _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                    A2($elm$html$Html$i, _List_fromArray([
                        $elm$html$Html$Attributes$class('icon ion-ios-arrow-back icon-button back-button'),
                        $elm$html$Html$Events$onClick($author$project$Main$ToggleSettings)
                    ]), _List_Nil),
                    A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('setting')
                    ]), _List_fromArray([
                        A2($elm$html$Html$label, _List_fromArray([
                            $elm$html$Html$Attributes$for('settings-player-name')
                        ]), _List_fromArray([
                            $elm$html$Html$text('Your name')
                        ])),
                        A2($elm$html$Html$input, _List_fromArray([
                            $elm$html$Html$Attributes$value(settings.name),
                            $elm$html$Html$Events$onInput(function(x) {
                                return $author$project$Main$SettingsEdit(function(s) {
                                    return _Utils_update(s, {
                                        name: x
                                    });
                                });
                            }),
                            $elm$html$Html$Events$onBlur($author$project$Main$SaveSettings(settings))
                        ]), _List_Nil)
                    ]))
                ]))
            ]))
    ...
    var $author$project$Main$viewSidebar = F3(function(g, chatMessage, gameView) {
        var sides = $elm$core$Dict$values(g.players);
        var playersOnSideB = $elm$core$List$length(A2($elm$core$List$filter, function(x) {
            return _Utils_eq(x, $author$project$Side$B);
        }, sides));
        var playersOnSideA = $elm$core$List$length(A2($elm$core$List$filter, function(x) {
            return _Utils_eq(x, $author$project$Side$A);
        }, sides));
        var _v0 = _Utils_Tuple2(g.player.side, gameView);
        if (_v0.a.$ === 'Nothing') {
            var _v1 = _v0.a;
            return _List_fromArray([
                A2($author$project$Main$viewJoinASide, playersOnSideA, playersOnSideB)
            ]);
        } else if (_v0.b.$ === 'ShowSettings') {
            var settings = _v0.b.a;
            return A2($author$project$Main$viewSettings, g, settings);
        } else {
            var side = _v0.a.a;
            var _v2 = _v0.b;
            return A3($author$project$Main$viewActiveSidebar, g, side, chatMessage);
        }
    });
    var $author$project$Main$viewGameInProgress = F3(function(g, chatMessage, gameView) {
        return A2($author$project$Main$viewLayout, $elm$core$Maybe$Nothing, A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$id('game')
        ]), _List_fromArray([
            A2($elm$html$Html$map, $author$project$Main$GameUpdate, $author$project$Game$viewBoard(g)),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$id('sidebar')
            ]), A3($author$project$Main$viewSidebar, g, chatMessage, gameView))
        ])));
    });
    var $perzanko$elm_loading$Loading$Circle = {
        $: 'Circle'
    };
    ...
    var $perzanko$elm_loading$Loading$Bars$view = function(config) {
        ...
        var outerStyle = _List_fromArray([
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(config.size)),
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(config.size)),
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
            A2($rtfeldman$elm_css$Css$margin2, $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$auto),
        ...
        var childStyle = _List_fromArray([
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(config.size / 3.5)),
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(config.size / 3.5)),
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(5)),
            $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex(config.color)),
            A2($rtfeldman$elm_css$Css$property, 'animation-duration', withSpeed(1.5) + 's'),
            ...
            $rtfeldman$elm_css$Css$animationName($rtfeldman$elm_css$Css$Animations$keyframes(_List_fromArray([
                _Utils_Tuple2(0, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$Animations$property, 'height', $elm$core$String$fromFloat(config.size / 3.5) + 'px'),
                    A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'translate3d(0,0,0)')
                ])),
                _Utils_Tuple2(50, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$Animations$property, 'height', $elm$core$String$fromFloat(config.size) + 'px'),
                    A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'translate3d(0,0,0)')
                ])),
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            ...
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(childStyle, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$property, 'animation-delay', withSpeed(1) + 's')
                ])))
            ]), _List_Nil),
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(childStyle, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$property, 'animation-delay', withSpeed(0.5) + 's')
                ])))
            ]), _List_Nil),
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(childStyle, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$property, 'animation-delay', withSpeed(0.0000001) + 's')
                ])))
            ]), _List_Nil)
        ]));
    };
    ...
    var $perzanko$elm_loading$Loading$BouncingBalls$view = function(config) {
        ...
        var childStyle = _List_fromArray([
            ...
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(config.size / 3.5)),
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(config.size / 3.5)),
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$pct(100)),
            $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex(config.color)),
            A2($rtfeldman$elm_css$Css$property, 'animation-duration', withSpeed(0.6) + 's'),
            A2($rtfeldman$elm_css$Css$property, 'animation-delay', withSpeed(0.1) + 's'),
            ...
            $rtfeldman$elm_css$Css$animationName($rtfeldman$elm_css$Css$Animations$keyframes(_List_fromArray([
                ...
                _Utils_Tuple2(50, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'translate3d(0,0,0) translateZ(0) translate(0,' + ($elm$core$String$fromFloat(config.size / 3.5) + 'px)'))
                ])),
                _Utils_Tuple2(100, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'translate3d(0,0,0) translateZ(0) translate(0,0)')
                ]))
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            ...
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(childStyle, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$property, 'animation-delay', withSpeed(0.2) + 's')
                ])))
            ]), _List_Nil),
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(childStyle, _List_fromArray([
                    A2($rtfeldman$elm_css$Css$property, 'animation-delay', withSpeed(0.3) + 's')
                ])))
            ]), _List_Nil)
        ]));
    };
    ...
    var $perzanko$elm_loading$Loading$Circle$view = function(config) {
        ...
        var outerStyle = _List_fromArray([
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(config.size)),
            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(config.size * 0.95)),
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
            A2($rtfeldman$elm_css$Css$margin2, $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$auto)
        ]);
        var childStyle = _List_fromArray([
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(config.size - 2 * (config.size * 0.17))),
            ...
            $rtfeldman$elm_css$Css$top($rtfeldman$elm_css$Css$px(0)),
            $rtfeldman$elm_css$Css$left($rtfeldman$elm_css$Css$px(0)),
            A2($rtfeldman$elm_css$Css$property, 'animation-duration', withSpeed(1.33) + 's'),
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            ...
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css($elm$core$List$concat(_List_fromArray([
                    childStyle,
                    _List_fromArray([
                        A2($rtfeldman$elm_css$Css$property, 'border', $elm$core$String$fromFloat(config.size * 0.17) + ('px ' + (config.color + ' solid'))),
                        $rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$num(0.25))
                    ])
                ])))
            ]), _List_Nil),
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css($elm$core$List$concat(_List_fromArray([
                    childStyle,
                    _List_fromArray([
                        A2($rtfeldman$elm_css$Css$property, 'border', $elm$core$String$fromFloat(config.size * 0.17) + 'px transparent solid'),
                        A2($rtfeldman$elm_css$Css$property, 'border-top', $elm$core$String$fromFloat(config.size * 0.17) + ('px ' + (config.color + ' solid'))),
                        $rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$num(0.8))
                    ])
                ])))
            ]), _List_Nil)
        ]));
    ...
    var $perzanko$elm_loading$Loading$DoubleBounce$view = function(config) {
        ...
        var innerStyle = _List_fromArray([
            ...
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$pct(50)),
            $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex(config.color)),
            $rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$num(0.6)),
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
            $rtfeldman$elm_css$Css$top($rtfeldman$elm_css$Css$px(0)),
            $rtfeldman$elm_css$Css$left($rtfeldman$elm_css$Css$px(0)),
            $rtfeldman$elm_css$Css$animationName($rtfeldman$elm_css$Css$Animations$keyframes(_List_fromArray([
            ...
            A2($rtfeldman$elm_css$Css$property, 'animation-duration', $elm$core$String$fromFloat(2 / config.speed) + 's'),
            A2($rtfeldman$elm_css$Css$property, 'animation-timing-function', 'ease-in-out'),
            A2($rtfeldman$elm_css$Css$property, 'animation-iteration-count', 'infinite')
        ]);
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
            ...
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$Attributes$css($elm$core$List$concat(_List_fromArray([
                    innerStyle,
                    _List_fromArray([
                        A2($rtfeldman$elm_css$Css$property, 'animation-delay', '-' + ($elm$core$String$fromFloat(1 / config.speed) + 's'))
                    ])
                ])))
            ]), _List_Nil)
        ]));
    ...
    var $perzanko$elm_loading$Loading$Sonar$view = function(config) {
        var outerStyle = _List_fromArray([
            ...
            $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
            A2($rtfeldman$elm_css$Css$margin2, $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$auto),
            $rtfeldman$elm_css$Css$before(_List_fromArray([
                A2($rtfeldman$elm_css$Css$property, 'content', '\' \''),
                $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
                $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$pct(50)),
                $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(config.size / 3)),
                $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$px(config.size / 3)),
                A2($rtfeldman$elm_css$Css$property, 'top', 'calc(50% - ' + ($elm$core$String$fromFloat(config.size / 6) + 'px)')),
                A2($rtfeldman$elm_css$Css$property, 'left', 'calc(50% - ' + ($elm$core$String$fromFloat(config.size / 6) + 'px)')),
                $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex(config.color)),
                A2($rtfeldman$elm_css$Css$property, 'animation-duration', $elm$core$String$fromFloat(3 / config.speed) + 's'),
                ...
                $rtfeldman$elm_css$Css$animationName($rtfeldman$elm_css$Css$Animations$keyframes(_List_fromArray([
                    ...
                    _Utils_Tuple2(15, _List_fromArray([
                        $rtfeldman$elm_css$Css$Animations$opacity($rtfeldman$elm_css$Css$num(1)),
                        A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'scale(0.5)')
                    ])),
                    _Utils_Tuple2(60, _List_fromArray([
                    ...
                    _Utils_Tuple2(90, _List_fromArray([
                        $rtfeldman$elm_css$Css$Animations$opacity($rtfeldman$elm_css$Css$num(0)),
                        A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'scale(3)')
                    ])),
                    _Utils_Tuple2(95, _List_fromArray([
                        $rtfeldman$elm_css$Css$Animations$opacity($rtfeldman$elm_css$Css$num(1))
                    ])),
                    _Utils_Tuple2(100, _List_fromArray([
                        $rtfeldman$elm_css$Css$Animations$opacity($rtfeldman$elm_css$Css$num(1)),
            ...
            $rtfeldman$elm_css$Css$after(_List_fromArray([
                A2($rtfeldman$elm_css$Css$property, 'content', '\' \''),
                $rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$absolute),
                $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$pct(50)),
                $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(config.size / 3)),
                ...
                A2($rtfeldman$elm_css$Css$property, 'top', 'calc(50% - ' + ($elm$core$String$fromFloat(config.size / 6) + 'px)')),
                A2($rtfeldman$elm_css$Css$property, 'left', 'calc(50% - ' + ($elm$core$String$fromFloat(config.size / 6) + 'px)')),
                A3($rtfeldman$elm_css$Css$border3, $rtfeldman$elm_css$Css$px(1), $rtfeldman$elm_css$Css$solid, $rtfeldman$elm_css$Css$hex(config.color)),
                $rtfeldman$elm_css$Css$opacity($rtfeldman$elm_css$Css$num(0)),
                A2($rtfeldman$elm_css$Css$property, 'animation-duration', $elm$core$String$fromFloat(3 / config.speed) + 's'),
                A2($rtfeldman$elm_css$Css$property, 'animation-timing-funtion', 'linear'),
                A2($rtfeldman$elm_css$Css$property, 'animation-iteration-count', 'infinite'),
                $rtfeldman$elm_css$Css$animationName($rtfeldman$elm_css$Css$Animations$keyframes(_List_fromArray([
                    ...
                    _Utils_Tuple2(30, _List_fromArray([
                        $rtfeldman$elm_css$Css$Animations$opacity($rtfeldman$elm_css$Css$num(0)),
                        A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'scale(1)')
                    ])),
                    _Utils_Tuple2(60, _List_fromArray([
                        $rtfeldman$elm_css$Css$Animations$opacity($rtfeldman$elm_css$Css$num(0.3))
                    ])),
                    _Utils_Tuple2(90, _List_fromArray([
                        A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'scale(3)')
                    ])),
            ...
            A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                ...
                return A2($rtfeldman$elm_css$Html$Styled$div, _List_fromArray([
                    $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
                        ...
                        $rtfeldman$elm_css$Css$left($rtfeldman$elm_css$Css$px(0)),
                        $rtfeldman$elm_css$Css$top($rtfeldman$elm_css$Css$px(0)),
                        A2($rtfeldman$elm_css$Css$property, 'transform', 'rotate(' + ($elm$core$String$fromInt(30 * x - 30) + 'deg)')),
                        $rtfeldman$elm_css$Css$before(_List_fromArray([
                            A2($rtfeldman$elm_css$Css$property, 'animation-delay', calcAnimationDelay(x)),
                            A2($rtfeldman$elm_css$Css$property, 'content', '\' \''),
                            $rtfeldman$elm_css$Css$display($rtfeldman$elm_css$Css$block),
                            A2($rtfeldman$elm_css$Css$margin2, $rtfeldman$elm_css$Css$px(0), $rtfeldman$elm_css$Css$auto),
                            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$pct(15)),
                            $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$pct(15)),
                            $rtfeldman$elm_css$Css$backgroundColor($rtfeldman$elm_css$Css$hex(config.color)),
                            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$pct(100)),
                            A2($rtfeldman$elm_css$Css$property, 'animation-duration', $elm$core$String$fromFloat(1.2 / config.speed) + 's'),
                            A2($rtfeldman$elm_css$Css$property, 'animation-iteration-count', 'infinite'),
                            ...
                            $rtfeldman$elm_css$Css$animationName($rtfeldman$elm_css$Css$Animations$keyframes(_List_fromArray([
                                ...
                                _Utils_Tuple2(40, _List_fromArray([
                                    A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'scale(1.0)')
                                ])),
                                _Utils_Tuple2(80, _List_fromArray([
                                    A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'scale(0.0)')
                                ])),
                                _Utils_Tuple2(100, _List_fromArray([
                                    A2($rtfeldman$elm_css$Css$Animations$property, 'transform', 'scale(0.0)')
    ...
    var $perzanko$elm_loading$Loading$render = F3(function(loaderType, config, loadingState) {
        ...
        if (loadingState.$ === 'On') return A2($elm$html$Html$div, _List_fromArray([
    ...
    var $author$project$Main$viewGameLoading = function(id) {
        return _List_fromArray([
            $author$project$Main$viewHeader,
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$id('game-loading')
            ]), _List_fromArray([
                A3($perzanko$elm_loading$Loading$render, $perzanko$elm_loading$Loading$Circle, _Utils_update($perzanko$elm_loading$Loading$defaultConfig, {
                    color: '#b7ec8a',
                    size: 100
    ...
    var $author$project$Main$IdChanged = function(a) {
        return {
            $: 'IdChanged',
            a: a
        };
    };
    var $author$project$Main$SubmitNewGame = {
        $: 'SubmitNewGame'
    };
    var $elm$html$Html$Attributes$name = $elm$html$Html$Attributes$stringProperty('name');
    var $author$project$Main$viewHome = function(id) {
        return {
            body: _List_fromArray([
                A2($elm$html$Html$div, _List_fromArray([
                    ...
                    A2($elm$html$Html$p, _List_Nil, _List_fromArray([
                        $elm$html$Html$text('Play cooperative Codenames online across multiple devices on a shared board. To create a new game or join an existing game, enter a game identifier and click \'Play\'.')
                    ])),
                    A2($elm$html$Html$form, _List_fromArray([
                        $elm$html$Html$Attributes$id('new-game'),
                        $elm$html$Html$Events$onSubmit($author$project$Main$SubmitNewGame)
                    ]), _List_fromArray([
                        A2($elm$html$Html$input, _List_fromArray([
                            $elm$html$Html$Attributes$id('game-id'),
                            $elm$html$Html$Attributes$name('game-id'),
                            $elm$html$Html$Attributes$value(id),
                            $elm$html$Html$Events$onInput($author$project$Main$IdChanged)
                        ]), _List_Nil),
                        A2($elm$html$Html$button, _List_Nil, _List_fromArray([
    ...
    var $author$project$Main$viewNotFound = A2($author$project$Main$viewLayout, $elm$core$Maybe$Just('Page not found'), A2($elm$html$Html$div, _List_fromArray([
        $elm$html$Html$Attributes$id('not-found')
    ]), _List_fromArray([
        A2($elm$html$Html$h2, _List_Nil, _List_fromArray([
            $elm$html$Html$text('Page not found')
        ])),
        A2($elm$html$Html$p, _List_Nil, _List_fromArray([
            $elm$html$Html$text('That page doesn\'t exist. '),
            A2($elm$html$Html$a, _List_fromArray([
                $elm$html$Html$Attributes$href('/')
            ]), _List_fromArray([
                $elm$html$Html$text('Go to the homepage')
            ]))
        ]))
    ])));
    var $author$project$Main$view = function(model) {
        ...
        switch(_v0.$){
            ...
            case 'Home':
                var id = _v0.a;
                return $author$project$Main$viewHome(id);
            case 'GameLoading':
                var id = _v0.a;
                return {
                    body: $author$project$Main$viewGameLoading(id),
                    title: 'Codenames Green'
                };
            case 'GameInProgress':
                var game = _v0.a;
                var chat = _v0.b;
                var gameView = _v0.c;
                return A3($author$project$Main$viewGameInProgress, game, chat, gameView);
            default:
                var msg = _v0.a;
                return $author$project$Main$viewError(msg);
        }
    };
            ...
            'init': $author$project$Main$main($elm$json$Json$Decode$value)({
                ...
                "types": {
                    ...
                    "aliases": {
                        "Api.Event": {
                            "args": [],
                            "type": "{ number : Basics.Int, typ : String.String, playerId : String.String, name : String.String, side : Maybe.Maybe Side.Side, index : Basics.Int, message : String.String }"
                        },
                        "Api.GameState": {
                            "args": [],
                            "type": "{ id : String.String, seed : String.String, words : List.List String.String, events : List.List Api.Event, oneLayout : List.List Color.Color, twoLayout : List.List Color.Color }"
                        },
                        "Api.Index": {
                            "args": [],
                            "type": "{ autogeneratedId : String.String }"
                        },
                        "Main.Settings": {
                            "args": [],
                        ...
                        "Cell.Cell": {
                            "args": [],
                            "type": "{ index : Basics.Int, word : String.String, a : ( Basics.Bool, Color.Color ), b : ( Basics.Bool, Color.Color ) }"
                        },
                        "Api.Update": {
                            "args": [],
                            "type": "{ seed : String.String, events : List.List Api.Event }"
                        }
                    },
                    "unions": {
                        "Main.Msg": {
                            ...
                            "tags": {
                                ...
                                "IndexData": [
                                    "Result.Result Http.Error Api.Index"
                                ],
                                "IdChanged": [
                                    "String.String"
                                ],
                                ...
                                "GotGame": [
                                    "Result.Result Http.Error Api.GameState"
                                ],
                                "ChatMessageChanged": [
                                    "String.String"
                                ],
                        ...
                        "Game.Msg": {
                            ...
                            "tags": {
                                ...
                                "LongPoll": [
                                    "String.String",
                                    "String.String",
                                    "Result.Result Http.Error Api.Update"
                                ],
                                "GameUpdate": [
                                    "Result.Result Http.Error Api.Update"
                                ],
...
},{}]},["K6oNp","8lqZg"], "8lqZg", "parcelRequire19ac")
